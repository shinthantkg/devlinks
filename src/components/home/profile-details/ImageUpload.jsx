    ...
    return (
        <div className={`${styles["dialog"]} ${styles["dialog-profile"]} flex flex-jc-sb flex-ai-c flex-gap-150`}>
            ...
            <div className={`flex flex-gap-30 flex-ai-c`}>
                <div className={`${styles["dialog-profile-image-upload"]} ${profileData.profilePicture === "" ? styles["dialog-profile-image-upload-none"] : null} flex flex-fd-c flex-jc-c flex-ai-c flex-gap-10`} style={profileData.profilePicture !== "" ? { backgroundImage: `url(${profileData.profilePicture})`} : null} onClick={handleClick}>
                    ...
                    <span className={`${styles["dialog-profile-image-upload-indicator"]} ${profileData.profilePicture === "" ? styles["dialog-profile-image-upload-indicator-purple"] : styles["dialog-profile-image-upload-indicator-white"]}`}>+ Upload Image</span>
