...
import profileStyles from "../../styles/modules/profile/_profile.module.scss"
import navbarStyles from "../../styles/modules/shared/_navbar.module.scss";
...
const Navbar = ({ pageType }) => {
    ...
    return (
        <header className={`${pageType === "profile" ? profileStyles["header"] : null}`}>
            <nav className={`flex flex-jc-sb flex-ai-c ${navbarStyles["navbar"]}`}>
                {
                    pageType === "home" ?
                        <>
                            ...
                            <div className={`flex flex-jc-c flex-gap-35`}>
                                <div className={`flex flex-jc-c flex-ai-c flex-gap-5 ${page === 0 ? navbarStyles["navbar-link-active"] : null}`}>
                                    ...
                                    <span className={`${navbarStyles["navbar-link"]}`} onClick={() => setPage(0)}>Links</span>
                                </div>

                                <div className={`flex flex-jc-c flex-gap-35`}>
                                    <div className={`flex flex-jc-c flex-ai-c flex-gap-5 ${page === 1 ? navbarStyles["navbar-link-active"] : null}`}>
                                        ...
                                        <span className={`${navbarStyles["navbar-link"]}`} onClick={() => setPage(1)}>Profile Details</span>
                                    </div>
                                </div>
                            </div>
